...
const MARKETPLACE_AGENTS = [
  { id: 'ip_manager', name: 'IP Manager', avatarImg: '/images/agents/lisa.jpg', color: 'from-zinc-600 to-zinc-500', category: 'Creator', price: 'Free', rating: 4.9, reviews: 1240, description: 'Manages IP licensing, authorizations, and royalty collection.', model: 'GPT-5.2', costPer1k: 0.005 },
  { id: 'legal', name: 'Legal Officer', avatarImg: '/images/agents/debian.jpg', color: 'from-red-500 to-rose-600', category: 'Creator', price: 'Free', rating: 4.8, reviews: 890, description: 'Monitors unauthorized use and sends DMCA takedowns.', model: 'Claude Opus 4.6', costPer1k: 0.003 },
  { id: 'community', name: 'Community Manager', avatarImg: '/images/agents/aria.jpg', color: 'from-pink-500 to-rose-500', category: 'Creator', price: 'Free', rating: 4.7, reviews: 2100, description: 'Runs community events and rewards top customers.', model: 'Gemini 3 Flash', costPer1k: 0.0001 },
  { id: 'growth', name: 'Growth Officer', avatarImg: '/images/agents/zephyr.jpg', color: 'from-emerald-500 to-teal-600', category: 'Creator', price: 'Free', rating: 4.6, reviews: 1560, description: 'Drives follower and subscriber growth across platforms.', model: 'Claude Sonnet 4.5', costPer1k: 0.003 },
  { id: 'analyst', name: 'Data Analyst', avatarImg: '/images/agents/eric.jpg', color: 'from-blue-500 to-indigo-600', category: 'Creator', price: 'Free', rating: 4.9, reviews: 3200, description: 'Deep analytics across all platforms with actionable insights.', model: 'GPT-5.2', costPer1k: 0.005 },
  { id: 'creativity', name: 'Creativity Officer', avatarImg: '/images/agents/nova.jpg', color: 'from-orange-400 to-amber-500', category: 'Creator', price: 'Free', rating: 4.8, reviews: 2800, description: 'Content ideation based on trends and audience behavior.', model: 'Gemini 3.1 Pro', costPer1k: 0.0002 },
  { id: 'marketing', name: 'Marketing Manager', avatarImg: '/images/agents/max.jpg', color: 'from-blue-500 to-cyan-500', category: 'Advertiser', price: 'Free', rating: 4.7, reviews: 980, description: 'End-to-end influencer campaign planning and execution.', model: 'GPT-5.1', costPer1k: 0.004 },
  { id: 'channel', name: 'Channel Manager', avatarImg: '/images/agents/chan.jpg', color: 'from-emerald-500 to-green-600', category: 'Supplier', price: 'Free', rating: 4.5, reviews: 560, description: 'Connects creators and suppliers for merch partnerships.', model: 'Claude Haiku 4.x', costPer1k: 0.0001 },
  { id: 'finance', name: 'Finance Officer', avatarImg: '/images/agents/finance.jpg', color: 'from-yellow-500 to-amber-600', category: 'Pro', price: '$9.99/mo', rating: 4.9, reviews: 1100, description: 'Cross-border payments, invoicing, and financial reporting.', model: 'GPT-5.2-Codex', costPer1k: 0.006 },
  { id: 'translation', name: 'Localization Agent', avatarImg: '/images/agents/localization.jpg', color: 'from-cyan-500 to-blue-600', category: 'Pro', price: '$4.99/mo', rating: 4.6, reviews: 430, description: 'Translates and localizes content for global audiences.', model: 'Gemini 3 Pro', costPer1k: 0.0003 },
]
