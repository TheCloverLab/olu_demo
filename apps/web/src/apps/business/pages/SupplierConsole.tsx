      ...
      {tab === 'rankings' && (
        <div className="space-y-3">
          {products
            ...
            .map((product, index) => (
              <div key={product.id} className="rounded-[28px] p-4 flex items-center gap-4 border border-[var(--olu-card-border)] bg-[var(--olu-section-bg)] shadow-[0_2px_12px_rgba(2,8,23,0.08)]">
      ...
      {tab === 'creators' && (
        <div className="space-y-3">
          {partnerships.map((partnership) => (
            <div key={partnership.id} className="rounded-[32px] p-4 border border-[var(--olu-card-border)] bg-[var(--olu-section-bg)] shadow-[0_2px_12px_rgba(2,8,23,0.08)]">
