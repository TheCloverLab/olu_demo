...
// Mock products data
const MOCK_PRODUCTS = [
  { id: 'p1', name: 'Neon City Hoodie', price: 59.99, image: '/images/products/hoodie.jpg', stock: 45, creatorId: 'luna', creatorName: 'Luna Chen' },
  { id: 'p2', name: 'Pixel Pin Set', price: 24.99, image: '/images/products/pins.jpg', stock: 120, creatorId: 'luna', creatorName: 'Luna Chen' },
  { id: 'p3', name: 'Luna Acrylic Stand', price: 34.99, image: '/images/products/stand.jpg', stock: 67, creatorId: 'luna', creatorName: 'Luna Chen' },
  { id: 'p4', name: 'Chibi Luna Plushie', price: 44.99, image: '/images/products/plushie.jpg', stock: 12, creatorId: 'luna', creatorName: 'Luna Chen' },
]
