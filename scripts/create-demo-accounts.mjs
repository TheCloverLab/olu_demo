...
const ACCOUNTS = [
  // ── Consumers (10) ──────────────────────────────────────────────
  { email: 'alex.demo@olu.app', handle: '@alexpark', name: 'Alex Park', color: 'from-pink-500 to-rose-600', modules: [], bio: 'Music lover and part-time DJ. Exploring the indie scene one beat at a time.', followers: 1240, following: 89, posts: 43 },
  { email: 'jordan.demo@olu.app', handle: '@jordanlee', name: 'Jordan Lee', color: 'from-blue-500 to-blue-700', modules: [], bio: 'Freelance photographer based in Seoul. Shooting street and portrait.', followers: 3200, following: 215, posts: 127 },
  { email: 'mia.demo@olu.app', handle: '@miazhang', name: 'Mia Zhang', color: 'from-violet-500 to-purple-600', modules: [], bio: 'UX designer by day, watercolor painter by night. Dog mom.', followers: 890, following: 312, posts: 56 },
  { email: 'ryan.demo@olu.app', handle: '@ryankim', name: 'Ryan Kim', color: 'from-amber-500 to-orange-600', modules: [], bio: 'Fitness junkie and meal prep enthusiast. Currently training for my first marathon.', followers: 2100, following: 178, posts: 89 },
  { email: 'sofia.demo@olu.app', handle: '@sofiamartinez', name: 'Sofia Martinez', color: 'from-rose-500 to-pink-600', modules: [], bio: 'Book reviewer and podcast host. Reading 52 books a year since 2023.', followers: 4500, following: 340, posts: 201 },
  { email: 'david.demo@olu.app', handle: '@davidchen', name: 'David Chen', color: 'from-emerald-500 to-green-600', modules: [], bio: 'Software engineer at a startup. Weekend rock climber.', followers: 670, following: 145, posts: 28 },
  { email: 'emma.demo@olu.app', handle: '@emmawilson', name: 'Emma Wilson', color: 'from-sky-500 to-blue-600', modules: [], bio: 'Travel blogger documenting hidden gems across Southeast Asia.', followers: 8900, following: 520, posts: 312 },
  { email: 'lucas.demo@olu.app', handle: '@lucasbrown', name: 'Lucas Brown', color: 'from-orange-500 to-red-600', modules: [], bio: 'Sneakerhead and streetwear collector. Always hunting for the next drop.', followers: 1800, following: 234, posts: 67 },
  { email: 'nina.demo@olu.app', handle: '@ninapatel', name: 'Nina Patel', color: 'from-yellow-500 to-amber-600', modules: [], bio: 'Med student and amateur chef. Cooking my way through residency.', followers: 950, following: 167, posts: 45 },
  { email: 'tyler.demo@olu.app', handle: '@tylerwang', name: 'Tyler Wang', color: 'from-teal-500 to-cyan-600', modules: [], bio: 'Competitive gamer and esports commentator. Rank: Immortal.', followers: 15600, following: 89, posts: 234 },
