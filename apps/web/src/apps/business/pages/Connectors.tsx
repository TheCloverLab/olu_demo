              ...
              <div className="space-y-4">
                <div className="rounded-xl bg-[var(--olu-card-bg)] border border-[var(--olu-card-border)] p-5 text-center">
                  <div className="w-14 h-14 rounded-2xl bg-cyan-400/10 flex items-center justify-center mx-auto mb-3">
                    <Monitor size={24} className="text-cyan-300" />
                  </div>
                  ...
                  <div className="space-y-2 text-left">
                    {[t('connectors.sandboxStep1'), t('connectors.sandboxStep2', { provider }), t('connectors.sandboxStep3')].map((step, i) => (
                      <div key={i} className="flex items-start gap-2.5">
                        <span className="w-5 h-5 rounded-full bg-cyan-400/10 text-cyan-300 flex items-center justify-center text-[10px] font-bold flex-shrink-0 mt-0.5">
                          {i + 1}
                        </span>
          ...
          <div className="flex items-center justify-end gap-2 px-6 py-4 border-t border-[var(--olu-card-border)]">
            ...
            {method === 'api_key' && (
              <button
                onClick={handleSave}
                disabled={saving}
                className="px-4 py-2 rounded-xl bg-cyan-400/15 text-cyan-300 text-sm font-medium hover:bg-cyan-400/25 transition-colors disabled:opacity-50 flex items-center gap-1.5"
              >
            ...
            {method === 'browser_session' && (
              <button
                className="px-4 py-2 rounded-xl bg-cyan-400/15 text-cyan-300 text-sm font-medium hover:bg-cyan-400/25 transition-colors flex items-center gap-1.5"
              >
                <Monitor size={14} />
