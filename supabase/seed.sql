...
-- 20 consumers, 8 creators, 2 marketing, 2 supply_chain
...
-- ── 4 Additional Creator Workspaces ──────────────────────────────
...
-- Product-experience linking for new workspaces
INSERT INTO workspace_product_experiences (product_id, experience_id) VALUES
...
-- New workspace home configs (different layout templates)
INSERT INTO workspace_home_configs (workspace_id, cover, headline, tabs)
VALUES
...
-- Forum posts for new workspaces
INSERT INTO forum_posts (id, experience_id, author_id, content, like_count, comment_count)
VALUES
...
-- Consumer purchases for new workspaces
INSERT INTO consumer_purchases (id, user_id, product_id, plan_id, status, started_at)
VALUES
...
-- Forum comments from new consumers
INSERT INTO forum_post_comments (id, post_id, author_id, content)
VALUES
...
-- Product ↔ Experience linking
-- Free Community → Skin Diaries + Product Reviews + Morning Routine Club
INSERT INTO workspace_product_experiences (product_id, experience_id) VALUES
...
-- Home config (Community-first layout)
INSERT INTO workspace_home_configs (workspace_id, cover, headline, tabs)
VALUES
...
-- Workspace agents (2): Community Manager (Aria) + Growth Officer (Zephyr)
...
-- Forum posts (3) in Skin Diaries and Product Reviews
INSERT INTO forum_posts (id, experience_id, author_id, content, like_count, comment_count)
VALUES
...
-- Workspace joins (existing fans join Sora's workspace)
INSERT INTO workspace_joins (user_id, workspace_id) VALUES
...
-- Consumer purchases (2 fans buy Glow Pass)
INSERT INTO consumer_purchases (id, user_id, product_id, plan_id, status, started_at)
VALUES
